...
## 5. Catálogo e integración externa

- [x] 5.1 Implementar `searchCatalog(term)` (endpoint vía `CATALOG_API_URL`, debounce, AbortController, timeout con error en español + reintento) y verificar búsqueda real contra el catálogo
...
- [x] 5.3 Mostrar precio con leyenda "Precio sugerido" en catálogo, búsqueda y lista — componente `SuggestedPrice` creado; la verificación en las tres vistas queda cubierta por el E2E de la tarea 7.3
...
- [x] 7.3 Implementar detalle de lista: agregar productos vía buscador del catálogo, marcar items, avanzar estado, sección invitados — verificar el flujo completo crear→listo
