...
El producto DEBERÁ mostrar imagen, nombre, marca y precio sugerido. El precio DEBERÁ presentarse siempre con la aclaración visible de que es un **precio sugerido de referencia** (basado en los precios del catálogo externo), no el precio del lugar donde el usuario compra.
